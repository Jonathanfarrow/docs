...
description: "Minns Memory Layer provides five distinct search methods. Learn which one to use for every situation."
---

Minns Memory Layer provides five distinct ways to find data. Choosing the right one is critical for your agent's performance.
