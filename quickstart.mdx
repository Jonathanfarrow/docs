---
title: "Quickstart"
description: "Get EventGraphDB running and log your first event in under 5 minutes."
---

## Prerequisites

- **EventGraphDB server** running locally or remotely (default: `http://localhost:3000`)
