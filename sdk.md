...
## Advanced: Events & Telemetry

For applications with explicit structured telemetry needs. Most integrations should use `sendMessage()` and `ingestConversations()` instead.
